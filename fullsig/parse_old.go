...
// // 		return eth_abi.Event{}, fmt.Errorf("event fullsig must start with 'event'")
// // 	}
...
// 		return eth_abi.Method{}, fmt.Errorf("method fullsig must start with 'function'")
// 	}
...
// 		return "", fmt.Errorf("bad identifier: %s", identifier)
// 	}
